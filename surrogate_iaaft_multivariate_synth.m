...
%
%
% [sk,rk,Niter]=surrogate_iaaft_multivariate_synth(ASk,PhSk,Ck,Nmaxiter);
%
...
function [sk,rk,Niter]=surrogate_iaaft_multivariate_synth(ASk,PhSk,Ck,Nmaxiter) ;


[Nmv,Nx]=size(Ck);      % Nmv = number of variables
