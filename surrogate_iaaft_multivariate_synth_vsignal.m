% Multivariate Synthesis of Non Gaussian Process with Surrogates
...
%
%
% [sk,rk,Niter]=surrogate_iaaft_multivariate_synth_vsignal(X,Nmaxiter);
%
% input:    X    original multivariate signal
...
function [sk,rk,Niter]=surrogate_iaaft_multivariate_synth_vsignal(X,Nmaxiter) ;


[Nmv,Nx]=size(X);       % Nmv = number of variables
